...
namespace Detector.Main
{
    public class ExtractionManager<T> : IExtractionManager where T : ORMToolType
    {
        ...
        {
            _progressIndicator.Report(new ExtractionProgress("Creating Roslyn solution..."));
            Solution solution = await new RoslynSolutionGenerator().GetSolutionAsync(string.Format(@"{0}\{1}.sln", folderPath, solutionUnderTest));
            _progressIndicator.Report(new ExtractionProgress("Solution created."));
            ...
            _progressIndicator.Report(new ExtractionProgress("Saved Data Context Declarations into json file."));
            ...
            _progressIndicator.Report(new ExtractionProgress("Saved Database Entity Declarations into json file."));
            ...
            _progressIndicator.Report(new ExtractionProgress("Saved Database Accessing Method Calls into json file."));
        }
    }
}
