...
{
    public class DatabaseAccessingMethodCallExtractor : CSharpSyntaxWalker, DatabaseAccessingMethodCallsExtractor<LINQToSQL>
    {
        ...
        public DatabaseAccessingMethodCallExtractor(SemanticModel model
