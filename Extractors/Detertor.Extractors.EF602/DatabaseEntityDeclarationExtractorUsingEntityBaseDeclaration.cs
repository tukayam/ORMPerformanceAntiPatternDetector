...
{
    /// <summary>
    /// Extracts Database Entity Declarations in a solution by detecting all classes of type base class name for entities given by user
    /// </summary>
    public class DatabaseEntityDeclarationExtractorUsingEntityBaseDeclaration : DatabaseEntityDeclarationExtractor<EntityFramework>
    {
        public DatabaseEntityDeclarationExtractorUsingEntityBaseDeclaration(Context<EntityFramework> context)
            : base(context)
        { }
