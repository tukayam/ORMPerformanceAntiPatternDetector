...
namespace Core.Viewmodels
{
    public sealed class MainViewmodel : NavigatorAwareBaseViewmodel
    {
        ...
        /// Constructor.
        /// </summary>
        public MainViewmodel(ISamplePlatformspecificService platformspecificService, SamplePortableService portableService, INavigatorService navigatorService) : base(navigatorService)
        {
